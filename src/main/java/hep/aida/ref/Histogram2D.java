...
/**
 * A reference implementation of {@link IHistogram2D}. The goal is to provide a clear implementation rather than the
 * most efficient implementation.
 */
@SuppressWarnings("unused")
public class Histogram2D extends AbstractHistogram2D implements IHistogram2D {
    @Serial
    private static final long serialVersionUID = -3296631313947321866L;
     ...
     * {@code xEdges = (0.2, 1.0, 5.0, 6.0), yEdges = (-5, 0, 7)} yields 3*2 in-range bins.
     *
     * @param title  The histogram title.
     * @param xEdges the bin boundaries the x-axis shall have; must be sorted ascending and must not contain multiple
     *               identical elements.
     * @param yEdges the bin boundaries the y-axis shall have; must be sorted ascending and must not contain multiple
     *               identical elements.
     * @throws IllegalArgumentException if {@code xEdges.length < 1 || yEdges.length < 1}.
     */
