...
/**
 * A reference implementation of {@link IHistogram3D}. The goal is to provide a clear implementation rather than the
...
public class Histogram3D extends AbstractHistogram3D implements IHistogram3D {
     ...
     * {@code xEdges = (0.2, 1.0, 5.0, 6.0), yEdges = (-5, 0, 7), zEdges = (-5, 0, 7)}
     * yields 3*2*2 in-range bins.
     *
     * @param title  The histogram title.
     * @param xEdges the bin boundaries the x-axis shall have; must be sorted
     *               ascending and must not contain multiple identical elements.
     * @param yEdges the bin boundaries the y-axis shall have; must be sorted
     *               ascending and must not contain multiple identical elements.
     * @param zEdges the bin boundaries the z-axis shall have; must be sorted
     *               ascending and must not contain multiple identical elements.
     * @throws IllegalArgumentException if{@code xEdges.length < 1 || yEdges.length < 1|| zEdges.length < 1}
     *                                  .
     */
     ...
     */
    public Histogram3D(String title, int xBins, double xMin, double xMax, int yBins, double yMin, double yMax,
     ...
     * <b>Note 2</b>indexX1 and indexX2 may include the use of under and overflow bins
     */
     ...
     * <b>Note 2</b>indexY1 and indexY2 may include the use of under and overflow bins
     */
