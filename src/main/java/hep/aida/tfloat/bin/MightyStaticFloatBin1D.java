...
public class MightyStaticFloatBin1D extends StaticFloatBin1D {
    ...
    public synchronized float geometricMean() {
        return FloatDescriptive.geometricMean(size(), sumOfLogarithms());
    }
    ...
    public synchronized float harmonicMean() {
        return FloatDescriptive.harmonicMean(size(), sumOfInversions());
    }
    ...
    public synchronized float kurtosis() {
        return FloatDescriptive.kurtosis(moment(4, mean()), standardDeviation());
    }
    ...
    public synchronized float moment(int k, float c) {
        ...
        return FloatDescriptive.moment(k, c, size(), sumOfPows.elements());
    }
    ...
    public float product() {
        return FloatDescriptive.product(size(), sumOfLogarithms());
    }
    ...
    protected void setMaxOrderForSumOfPowers(int max_k) {
        ...
        if (max_k <= 2) {
            ...
            this.sumOfPowers = new float[max_k - 2];
        }
    }
    ...
    public synchronized float skew() {
        return FloatDescriptive.skew(moment(3, mean()), standardDeviation());
    }
    ...
    protected void xcheckOrder(int k) {
        // if (! isLegalOrder(k)) return Float.NaN;
