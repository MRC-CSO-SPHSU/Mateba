 ...
 */
abstract class DoubleAbstractHistogram2D extends DoubleHistogram implements DoubleIHistogram2D {
    /**
     * 
     */
    private static final long serialVersionUID = 1L;
    protected DoubleIAxis xAxis, yAxis;

    DoubleAbstractHistogram2D(String title) {
        super(title);
    }
     ...
     */
    protected abstract DoubleIHistogram1D internalSliceX(String title, int indexY1, int indexY2);
     ...
     * flow bins <b>Note 3</b>There is no note 3 (yet)
     */
    protected abstract DoubleIHistogram1D internalSliceY(String title, int indexX1, int indexX2);
    ...
    public DoubleIHistogram1D projectionX() {
        ...
        return internalSliceX(newTitle, mapY(DoubleIHistogram.UNDERFLOW), mapY(DoubleIHistogram.OVERFLOW));
    }
    ...
    public DoubleIHistogram1D projectionY() {
        ...
        return internalSliceY(newTitle, mapX(DoubleIHistogram.UNDERFLOW), mapX(DoubleIHistogram.OVERFLOW));
    }
