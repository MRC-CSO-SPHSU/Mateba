 ...
 */
public abstract class AbstractDoubleBin1D extends AbstractDoubleBin implements
        cern.colt.buffer.tdouble.DoubleBufferConsumer {
    /**
     * 
     */
     ...
     */
    public synchronized cern.colt.buffer.tdouble.DoubleBuffer buffered(int capacity) {
        return new cern.colt.buffer.tdouble.DoubleBuffer(this, capacity);
    }
