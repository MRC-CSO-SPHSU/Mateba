...
public class Units {
    ...
    public static final double e_SI = 1.60217733e-19; // positron charge in

    // coulomb

    public static final double coulomb = eplus / e_SI; // coulomb = 6.24150
    ...
    public static final double joule = electronvolt / e_SI; // joule = 6.24150
    ...
    // Power [E][T^-1]
    //
    public static final double watt = joule / second; // watt = 6.24150 e+3 *
    ...
    // Force [E][L^-1]
    //
    public static final double newton = joule / meter; // newton = 6.24150 e+9
    ...
    // Pressure [E][L^-3]
    //
    public static final double hep_pascal = newton / m2; // pascal = 6.24150

    // e+3 * MeV/mm3

    public static final double pascal = hep_pascal;

    public static final double bar = 100000 * pascal; // bar = 6.24150 e+8 *

    // MeV/mm3

    public static final double atmosphere = 101325 * pascal; // atm = 6.32420
    ...
    //
    public static final double ampere = coulomb / second; // ampere = 6.24150
    ...
    //
    public static final double ohm = volt / ampere; // ohm =

    // 1.60217e-16*(MeV/eplus)/(eplus/ns)

    //
    // Electric capacitance [Q^2][E^-1]
    //
    public static final double farad = coulomb / volt; // farad = 6.24150e+24 *
    ...
    //
    public static final double weber = volt * second; // weber =
    ...
    //
    public static final double tesla = volt * second / meter2; // tesla
    ...
    //
    public static final double henry = weber / ampere; // henry =
