...
/**
 * Target of a streaming {@link CharBuffer2D} into which data is flushed upon buffer overflow.
 */
public interface CharBuffer2DConsumer {
    /**
     ...
     */
    void addAllOf(final @NotNull CharArrayList x, final @NotNull CharArrayList y);
}
