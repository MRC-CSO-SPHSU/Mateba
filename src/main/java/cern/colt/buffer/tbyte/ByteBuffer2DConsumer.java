...
/**
 * Target of a streaming {@link ByteBuffer2D} into which data is flushed upon buffer overflow.
 */
public interface ByteBuffer2DConsumer {
     ...
     */
    void addAllOf(final @NotNull ByteArrayList x, final @NotNull ByteArrayList y);
}
