...
/**
 * Target of a streaming {@code ByteBuffer3D} into which data is flushed upon buffer overflow.
 */
public interface ByteBuffer3DConsumer {
     ...
     */
    void addAllOf(final @NotNull ByteArrayList x, final @NotNull ByteArrayList y, final @NotNull ByteArrayList z);
}
