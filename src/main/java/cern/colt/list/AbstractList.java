...
public abstract class AbstractList extends AbstractCollection {
     ...
     * <i>stable</i>: equal elements will not be reordered as a result of the
     * sort.
     * <p>
     * 
    ...
    /**
     * Sorts the receiver into ascending order. The sorting algorithm is a tuned
     * quicksort, adapted from Jon L. Bentley and M. Douglas McIlroy's
     * "Engineering a Sort Function", Software-Practice and Experience, Vol.
     * 23(11) P. 1249-1265 (November 1993). This algorithm offers n*log(n)
    ...
    /**
     * Randomly permutes the receiver. After invocation, all elements will be at
     * random positions.
     */
     ...
     * 
     * The sorting algorithm is dynamically chosen according to the
     * characteristics of the data set. This default implementation simply calls
     * quickSort. Override this method if you can determine which sort is most
     * appropriate for the given data set.
     * 
     * @param from
     *            the index of the first element (inclusive) to be sorted.
