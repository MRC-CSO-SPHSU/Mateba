...
/**
 * Adapter that permits an {@link cern.colt.list.tint.AbstractIntList} to be
 ...
 * <tt>java.lang.Number.intValue()</tt> is used to convert objects into
 * primitive values which are then stored in the backing templated list. Getter
 * methods return <tt>java.lang.Integer</tt> objects.
 */
