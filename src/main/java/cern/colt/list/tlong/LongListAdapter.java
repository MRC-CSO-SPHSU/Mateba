...
/**
 * Adapter that permits an {@link cern.colt.list.tlong.AbstractLongList} to be
 ...
 * <tt>java.lang.Number.longValue()</tt> is used to convert objects into
 * primitive values which are then stored in the backing templated list. Getter
 * methods return <tt>java.lang.Long</tt> objects.
 */
