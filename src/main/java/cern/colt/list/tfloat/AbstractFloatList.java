...
/**
 * Abstract base class for resizable lists holding <code>float</code> elements;
 ...
 * picture.
 */
public abstract class AbstractFloatList extends AbstractList implements cern.colt.buffer.tfloat.FloatBufferConsumer {
    /**
     * 
     */
