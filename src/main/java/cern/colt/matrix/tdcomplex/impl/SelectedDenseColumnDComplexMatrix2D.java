...
class SelectedDenseColumnDComplexMatrix2D extends DComplexMatrix2D {
     ...
     * @param offset
     */
    protected SelectedDenseColumnDComplexMatrix2D(double[] elements, int[] rowOffsets, int[] columnOffsets, int offset) {
     ...
     * @param offset
     */
    protected SelectedDenseColumnDComplexMatrix2D(int rows, int columns, double[] elements, int rowZero,
