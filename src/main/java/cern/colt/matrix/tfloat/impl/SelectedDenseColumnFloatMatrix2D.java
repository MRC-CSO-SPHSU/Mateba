...
/**
 * Selection view on dense 2-d matrices holding <tt>float</tt> elements. First
 ...
 */
class SelectedDenseColumnFloatMatrix2D extends FloatMatrix2D {
    /**
     * 
     */
     ...
     * @param offset
     */
    protected SelectedDenseColumnFloatMatrix2D(int rows, int columns, float[] elements, int rowZero, int columnZero,
     ...
     * <tt>DenseColFloatMatrix2D</tt> the new matrix must also be of type
     * <tt>DenseColFloatMatrix2D</tt>, if the receiver is an instance of type
     * <tt>SparseColFloatMatrix2D</tt> the new matrix must also be of type
     * <tt>SparseColFloatMatrix2D</tt>, etc. In general, the new matrix should
     ...
     * receiver is an instance of type <tt>DenseColFloatMatrix2D</tt> the new
     * matrix must be of type <tt>DenseFloatMatrix1D</tt>, if the receiver is an
     * instance of type <tt>SparseColFloatMatrix2D</tt> the new matrix must be
     ...
     * instance of type <tt>DenseColFloatMatrix2D</tt> the new matrix must be of
     * type <tt>DenseFloatMatrix1D</tt>, if the receiver is an instance of type
     * <tt>SparseColFloatMatrix2D</tt> the new matrix must be of type
