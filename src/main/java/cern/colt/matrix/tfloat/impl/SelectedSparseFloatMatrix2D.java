...
/**
 * Selection view on sparse 2-d matrices holding <tt>float</tt> elements. First
 ...
 */
class SelectedSparseFloatMatrix2D extends FloatMatrix2D {
    /**
     * 
     */
     ...
     * @param offset
     */
    protected SelectedSparseFloatMatrix2D(AbstractLongFloatMap elements, int[] rowOffsets, int[] columnOffsets,
            int offset) {
     ...
     * @param offset
     */
    protected SelectedSparseFloatMatrix2D(int rows, int columns, AbstractLongFloatMap elements, int rowZero,
    ...
    public FloatMatrix1D viewColumn(int column) {
        ...
        return new SelectedSparseFloatMatrix1D(viewSize, this.elements, viewZero, viewStride, viewOffsets, viewOffset);
    }
