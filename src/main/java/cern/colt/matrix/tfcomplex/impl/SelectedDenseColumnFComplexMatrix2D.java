 ...
 */
class SelectedDenseColumnFComplexMatrix2D extends FComplexMatrix2D {
     ...
     * @param offset
     */
    protected SelectedDenseColumnFComplexMatrix2D(float[] elements, int[] rowOffsets, int[] columnOffsets, int offset) {
     ...
     * @param offset
     */
    protected SelectedDenseColumnFComplexMatrix2D(int rows, int columns, float[] elements, int rowZero, int columnZero,
