 ...
 */
public abstract class AbstractIntFloatMap extends AbstractMap {
    /**
     * 
     */
    ...
    public void assign(final cern.colt.function.tfloat.FloatFunction function) {
        copy().forEachPair(new cern.colt.function.tfloat.IntFloatProcedure() {
    ...
    public boolean containsValue(final float value) {
        return !forEachPair(new IntFloatProcedure() {
     ...
     */
    public int keyOf(final float value) {
        final int[] foundKey = new int[1];
        boolean notFound = forEachPair(new IntFloatProcedure() {
            public boolean apply(int iterKey, float iterValue) {
     ...
     * 
     * <pre>
     * 	 IntFloatProcedure condition = new IntFloatProcedure() { // match even keys only
     * 	 public boolean apply(int key, float value) { return key%2==0; }
     * 	 }
    ...
    public void pairsMatching(final IntFloatProcedure condition, final IntArrayList keyList,
        ...
        forEachPair(new IntFloatProcedure() {
            public boolean apply(int key, float value) {
     ...
     *            the list to be filled with values, can have any size.
     */
    public void pairsSortedByKey(final IntArrayList keyList, final FloatArrayList valueList) {
        keys(keyList);
        keyList.sort();
     ...
     *            the list to be filled with values, can have any size.
     */
    public void pairsSortedByValue(final IntArrayList keyList, final FloatArrayList valueList) {
        keys(keyList);
        values(valueList);
     ...
     */
    public abstract boolean put(int key, float value);
