...
/**
 * Hash map holding (key,value) associations of type <tt>(float-->long)</tt>;
...
public class OpenFloatLongHashMap extends AbstractFloatLongMap {
    ...
    public Object clone() {
        OpenFloatLongHashMap copy = (OpenFloatLongHashMap) super.clone();
