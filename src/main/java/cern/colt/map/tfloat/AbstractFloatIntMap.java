 ...
 * <tt>(float-->int)</tt>. First see the <a href="package-summary.html">package
 ...
 */
public abstract class AbstractFloatIntMap extends AbstractMap {
    /**
     * 
     */
    ...
    public boolean containsValue(final int value) {
        return !forEachPair(new FloatIntProcedure() {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof AbstractFloatIntMap))
            return false;
        final AbstractFloatIntMap other = (AbstractFloatIntMap) obj;
        if (other.size() != size())
            return false;
        ...
        }) && other.forEachPair(new FloatIntProcedure() {
            public boolean apply(float key, int value) {
     ...
     *         such key is present.
     */
    public abstract int get(float key);
     ...
     */
    public float keyOf(final int value) {
        final float[] foundKey = new float[1];
        boolean notFound = forEachPair(new FloatIntProcedure() {
            public boolean apply(float iterKey, int iterValue) {
     ...
     * 
     * <pre>
     * 	 FloatIntProcedure condition = new FloatIntProcedure() { // match even values only
     ...
     */
    public void pairsMatching(final FloatIntProcedure condition, final FloatArrayList keyList,
            final IntArrayList valueList) {
        keyList.clear();
        valueList.clear();

        forEachPair(new FloatIntProcedure() {
            public boolean apply(float key, int value) {
     ...
     *            the list to be filled with values, can have any size.
     */
    public void pairsSortedByKey(final FloatArrayList keyList, final IntArrayList valueList) {
        /*
         * keys(keyList); values(valueList);
         * 
         * final float[] k = keyList.elements(); final int[] v =
         * valueList.elements(); cern.colt.Swapper swapper = new
         * cern.colt.Swapper() { public void swap(int a, int b) { int t1; float
        ...
        // cern.colt.map.OpenFloatIntHashMap.hashCollisions = 0;
        // System.out.println("collisions="+cern.colt.map.OpenFloatIntHashMap.hashCollisions);
        keys(keyList);
        keyList.sort();
     ...
     *            the list to be filled with values, can have any size.
     */
    public void pairsSortedByValue(final FloatArrayList keyList, final IntArrayList valueList) {
        keys(keyList);
        values(valueList);
     ...
     */
    public abstract boolean put(float key, int value);
