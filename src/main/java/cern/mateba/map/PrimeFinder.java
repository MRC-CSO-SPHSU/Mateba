...
public class PrimeFinder {
    ...
    static { // initializer
        ...
        // new cern.mateba.list.IntArrayList(primeCapacities).mergeSort(); // for
        // debug only, TODO
    }
    ...
    public static int nextPrime(int desiredCapacity) {
        ...
        // int i = new
        // cern.mateba.list.IntArrayList(primeCapacities).binarySearch(desiredCapacity);
        // // for debug only TODO
        if (i < 0) {
