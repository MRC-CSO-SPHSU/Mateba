...
import cern.mateba.map.HashFunctions;
import cern.mateba.map.PrimeFinder;

import java.io.Serial;

/**
 * Hash map holding (key,value) associations of type <tt>(long-->long)</tt>;
...
public class OpenLongLongHashMap extends AbstractLongLongMap {
    ...
    @Serial
    private static final long serialVersionUID = -3977231086273591041L;
    /**
     * The hash table keys.
     *
     * @serial
     ...
     */
    public OpenLongLongHashMap(int initialCapacity) {
     ...
     *                                  .
     */
    public OpenLongLongHashMap(int initialCapacity, double minLoadFactor, double maxLoadFactor) {
    ...
    public void clear() {
        ...
        // new LongArrayList(values).fillFromToWith(0, state.length-1, 0); //
        // delta
    ...
    public OpenLongLongHashMap clone() {
        var copy = (OpenLongLongHashMap) super.clone();
    ...
    public boolean put(long key, long value) {
        ...
        if (this.distinct > this.highWaterMark) {
            ...
            // System.out.println("at distinct="+distinct+",
