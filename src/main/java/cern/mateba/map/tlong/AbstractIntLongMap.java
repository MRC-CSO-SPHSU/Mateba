...
import cern.mateba.function.tlong.IntLongProcedure;
 ...
 * <tt>(int-->long)</tt>. First see the <a href="package-summary.html">package
 ...
 * {@link #forEachKey(IntProcedure)}. As such they are fully functional, but
...
public abstract class AbstractIntLongMap extends AbstractMap {
    @Serial
    private static final long serialVersionUID = -5945310229479786717L;
    ...
    public void assign(final cern.mateba.function.tlong.LongFunction function) {
        copy().forEachPair(new cern.mateba.function.tlong.IntLongProcedure() {
    ...
    public boolean containsValue(final long value) {
        return !forEachPair(new IntLongProcedure() {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof final AbstractIntLongMap other))
            return false;
        if (other.size() != size())
            return false;
    ...
    public int keyOf(final long value) {
        ...
        boolean notFound = forEachPair(new IntLongProcedure() {
            public boolean apply(int iterKey, long iterValue) {
     ...
     *
     * <pre>
     *   IntLongProcedure condition = new IntLongProcedure() { // match even keys only
     ...
     */
    public void pairsMatching(final IntLongProcedure condition, final IntArrayList keyList,
                              final LongArrayList valueList) {
        keyList.clear();
        valueList.clear();

        forEachPair(new IntLongProcedure() {
            public boolean apply(int key, long value) {
     ...
     * @param valueList the list to be filled with values, can have any size.
     */
    public void pairsSortedByKey(final IntArrayList keyList, final LongArrayList valueList) {
        keys(keyList);
        keyList.sort();
     ...
     * @param valueList the list to be filled with values, can have any size.
     */
    public void pairsSortedByValue(final IntArrayList keyList, final LongArrayList valueList) {
        keys(keyList);
        values(valueList);
     ...
     */
    public abstract boolean put(int key, long value);
