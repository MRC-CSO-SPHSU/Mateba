...
import cern.mateba.function.tlong.LongIntProcedure;
...
public abstract class AbstractLongIntMap extends AbstractMap {
    ...
    public void assign(final cern.mateba.function.tint.IntFunction function) {
        copy().forEachPair(new cern.mateba.function.tlong.LongIntProcedure() {
    ...
    public boolean containsValue(final int value) {
        return !forEachPair(new LongIntProcedure() {
    ...
    public long keyOf(final int value) {
        ...
        boolean notFound = forEachPair(new LongIntProcedure() {
            public boolean apply(long iterKey, int iterValue) {
    ...
    public void pairsMatching(final LongIntProcedure condition, final LongArrayList keyList,
        ...
        forEachPair(new LongIntProcedure() {
            public boolean apply(long key, int value) {
