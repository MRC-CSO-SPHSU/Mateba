...
/**
 * Hash map holding (key,value) associations of type <tt>(int-->long)</tt>;
 ...
 */
public class OpenIntLongHashMap extends AbstractIntLongMap {

    protected static final byte FREE = 0;
    protected static final byte FULL = 1;
    protected static final byte REMOVED = 2;
    @Serial
    private static final long serialVersionUID = 5010356082830056184L;
    /**
     * The hash table keys.
     *
     * @serial
    ...
    public OpenIntLongHashMap clone() {
        var copy = (OpenIntLongHashMap) super.clone();
