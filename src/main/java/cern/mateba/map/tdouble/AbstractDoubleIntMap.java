...
import cern.mateba.function.tdouble.DoubleIntProcedure;
...
public abstract class AbstractDoubleIntMap extends AbstractMap {
    @Serial
    private static final long serialVersionUID = 9168751096399217008L;
    ...
    public double keyOf(final int value) {
        ...
        boolean notFound = forEachPair(new DoubleIntProcedure() {
            public boolean apply(double iterKey, int iterValue) {
    ...
    public void pairsSortedByKey(final DoubleArrayList keyList, final IntArrayList valueList) {
         ...
         * cern.mateba.MultiSorting.sort(0,keyList.size(),comp,swapper);
         */

        // this variant may be quicker
        // cern.mateba.map.OpenDoubleIntHashMap.hashCollisions = 0;
