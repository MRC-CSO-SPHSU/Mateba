 ...
 */
package cern.mateba.map.tdouble;

import cern.mateba.function.tdouble.DoubleLongProcedure;
 ...
 * <tt>(double-->long)</tt>. First see the <a
...
public abstract class AbstractDoubleLongMap extends AbstractMap {
    @Serial
    private static final long serialVersionUID = -2467915577199977763L;
    ...
    public boolean containsValue(final long value) {
        return !forEachPair(new DoubleLongProcedure() {
            public boolean apply(double iterKey, long iterValue) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof AbstractDoubleLongMap))
            return false;
        final AbstractDoubleLongMap other = (AbstractDoubleLongMap) obj;
        if (other.size() != size())
            return false;
        ...
        }) && other.forEachPair(new DoubleLongProcedure() {
            public boolean apply(double key, long value) {
     ...
     *         such key is present.
     */
    public abstract long get(double key);
     ...
     */
    public double keyOf(final long value) {
        final double[] foundKey = new double[1];
        boolean notFound = forEachPair(new DoubleLongProcedure() {
            public boolean apply(double iterKey, long iterValue) {
    ...
    public void pairsMatching(final DoubleLongProcedure condition, final DoubleArrayList keyList,
        ...
        forEachPair(new DoubleLongProcedure() {
            public boolean apply(double key, long value) {
     ...
     *            the list to be filled with values, can have any size.
     */
    public void pairsSortedByKey(final DoubleArrayList keyList, final LongArrayList valueList) {
        keys(keyList);
        keyList.sort();
     ...
     *            the list to be filled with values, can have any size.
     */
    public void pairsSortedByValue(final DoubleArrayList keyList, final LongArrayList valueList) {
        keys(keyList);
        values(valueList);
     ...
     */
    public abstract boolean put(double key, long value);
