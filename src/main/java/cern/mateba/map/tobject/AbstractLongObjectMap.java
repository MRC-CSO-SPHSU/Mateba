...
import cern.mateba.function.tobject.LongObjectProcedure;
...
public abstract class AbstractLongObjectMap extends AbstractMap {
    @Serial
    private static final long serialVersionUID = 3985460860122190474L;
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof final AbstractLongObjectMap other))
            return false;
        if (other.size() != size())
            return false;
    ...
    public long keyOf(final Object value) {
        ...
        boolean notFound = forEachPair(new LongObjectProcedure() {
            public boolean apply(long iterKey, Object iterValue) {
