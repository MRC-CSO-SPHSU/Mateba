 ...
 */
package cern.mateba.map.tobject;

import cern.mateba.function.tint.IntProcedure;
import cern.mateba.function.tobject.IntObjectProcedure;
 ...
 * <tt>(int-->Object)</tt>. First see the <a href="package-summary.html">package
...
public abstract class AbstractIntObjectMap extends AbstractMap {
    @Serial
    private static final long serialVersionUID = 1889843209103540801L;
    ...
    public boolean containsValue(final Object value) {
        return !forEachPair(new IntObjectProcedure() {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof final AbstractIntObjectMap other))
            return false;
        if (other.size() != size())
            return false;
    ...
    public int keyOf(final Object value) {
        ...
        boolean notFound = forEachPair(new IntObjectProcedure() {
            public boolean apply(int iterKey, Object iterValue) {
