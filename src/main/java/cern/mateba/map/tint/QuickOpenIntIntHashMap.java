...
public class QuickOpenIntIntHashMap extends OpenIntIntHashMap {
    ...
    public boolean put(int key, int value) {
         ...
         * variation". Brent's variation slows insertions a bit down (not much)
        ...
        if (decrement == 0)
            decrement = 1;
        // System.out.println("insert search for (key,value)=("+key+","+value+")
        // at i="+i+", dec="+decrement);
        ...
        // if (comparisons-comp>0) System.out.println("probed
        // "+(comparisons-comp)+" slots.");
        if (stat[i] == FULL) {
