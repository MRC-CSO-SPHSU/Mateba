...
public abstract class AbstractIntIntMap extends AbstractMap {
    @Serial
    private static final long serialVersionUID = -5991285241245778165L;
     ...
     *                 value.
     */
    public void assign(final cern.mateba.function.tint.IntFunction function) {
        copy().forEachPair(new cern.mateba.function.tint.IntIntProcedure() {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof final AbstractIntIntMap other))
            return false;
        if (other.size() != size())
            return false;
    ...
    public int keyOf(final int value) {
        ...
        boolean notFound = forEachPair(new IntIntProcedure() {
            public boolean apply(int iterKey, int iterValue) {
