...
/**
 * Target of a streaming {@link IntBuffer3D} into which data is flushed upon buffer overflow.
 */
public interface IntBuffer3DConsumer {
     ...
     */
    void addAllOf(final @NotNull IntArrayList x, final @NotNull IntArrayList y, final @NotNull IntArrayList z);
}
