...
class SelectedDenseColumnIntMatrix2D extends IntMatrix2D {
     ...
     * @param offset
     */
    protected SelectedDenseColumnIntMatrix2D(int[] elements, int[] rowOffsets, int[] columnOffsets, int offset) {
     ...
     * @param offset
     */
    protected SelectedDenseColumnIntMatrix2D(int rows, int columns, int[] elements, int rowZero, int columnZero,
     ...
     * <tt>DenseColIntMatrix2D</tt> the new matrix must also be of type
     * <tt>DenseColIntMatrix2D</tt>, if the receiver is an instance of type
     * <tt>SparseColIntMatrix2D</tt> the new matrix must also be of type
     * <tt>SparseColIntMatrix2D</tt>, etc. In general, the new matrix should
     ...
     * receiver is an instance of type <tt>DenseColIntMatrix2D</tt> the new
     * matrix must be of type <tt>DenseIntMatrix1D</tt>, if the receiver is an
     * instance of type <tt>SparseColIntMatrix2D</tt> the new matrix must be of
     * type <tt>SparseIntMatrix1D</tt>, etc.
     *
    ...
    protected boolean haveSharedCellsRaw(IntMatrix2D other) {
        if (other instanceof SelectedDenseColumnIntMatrix2D otherMatrix) {
            return this.elements == otherMatrix.elements;
        } else if (other instanceof DenseColumnIntMatrix2D otherMatrix) {
            return this.elements == otherMatrix.elements;
        }
        return false;
    }
     ...
     * instance of type <tt>DenseColIntMatrix2D</tt> the new matrix must be of
     * type <tt>DenseIntMatrix1D</tt>, if the receiver is an instance of type
     * <tt>SparseColIntMatrix2D</tt> the new matrix must be of type
    ...
    protected IntMatrix2D viewSelectionLike(int[] rowOffsets, int[] columnOffsets) {
        return new SelectedDenseColumnIntMatrix2D(this.elements, rowOffsets, columnOffsets, this.offset);
    }
}
