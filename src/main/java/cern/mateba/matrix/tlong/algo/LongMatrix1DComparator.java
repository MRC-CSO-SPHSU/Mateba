 ...
 * <tt>cern.mateba.matrix.doublealgo.Sorting.quickSort</tt>) to allow precise
 ...
 */
public interface LongMatrix1DComparator {
    /**
     ...
     */
    int compare(LongMatrix1D o1, LongMatrix1D o2);
