 ...
 * };<br>
 * matrix = new DenseLongMatrix2D(values);</tt>
 * </p>
 * </td>
 * </tr>
 * </table>
 ...
 * LongMatrix2D matrix = new DenseLongMatrix2D(values); <br>
...
public class LongFormatter extends AbstractFormatter {
     ...
     */
    protected String toTitleString(LongMatrix2D matrix, String[] rowNames, String[] columnNames, String rowAxisName,
     ...
     * @return the matrix converted to a string.
     */
    private String xtoTitleString(LongMatrix3D matrix, String[] sliceNames, String[] rowNames, String[] columnNames,
