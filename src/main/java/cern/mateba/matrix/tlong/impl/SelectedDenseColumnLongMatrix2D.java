 ...
 */
class SelectedDenseColumnLongMatrix2D extends LongMatrix2D {
    /**
     *
     */
    @Serial
     ...
     * @param offset
     */
    protected SelectedDenseColumnLongMatrix2D(int rows, int columns, long[] elements, int rowZero, int columnZero,
     ...
     * <tt>DenseColLongMatrix2D</tt> the new matrix must also be of type
     * <tt>DenseColLongMatrix2D</tt>, if the receiver is an instance of type
     * <tt>SparseColLongMatrix2D</tt> the new matrix must also be of type
     * <tt>SparseColLongMatrix2D</tt>, etc. In general, the new matrix should
     ...
     * receiver is an instance of type <tt>DenseColLongMatrix2D</tt> the new
     * matrix must be of type <tt>DenseLongMatrix1D</tt>, if the receiver is an
     * instance of type <tt>SparseColLongMatrix2D</tt> the new matrix must be of
    ...
    public LongMatrix1D vectorize() {
        DenseLongMatrix1D v = new DenseLongMatrix1D((int) size());
        int idx = 0;
    ...
    protected boolean haveSharedCellsRaw(LongMatrix2D other) {
        if (other instanceof SelectedDenseColumnLongMatrix2D otherMatrix) {
            return this.elements == otherMatrix.elements;
        } else if (other instanceof DenseColumnLongMatrix2D otherMatrix) {
            return this.elements == otherMatrix.elements;
        }
        return false;
    }
     ...
     * instance of type <tt>DenseColLongMatrix2D</tt> the new matrix must be of
     * type <tt>DenseLongMatrix1D</tt>, if the receiver is an instance of type
     * <tt>SparseColLongMatrix2D</tt> the new matrix must be of type
