 ...
 */
class SelectedDenseLongMatrix2D extends LongMatrix2D {
    /**
     *
     */
    @Serial
    private static final long serialVersionUID = -5025099228448386160L;
     ...
     * @param offset
     */
    protected SelectedDenseLongMatrix2D(long[] elements, int[] rowOffsets, int[] columnOffsets, int offset) {
     ...
     * @param offset
     */
    protected SelectedDenseLongMatrix2D(int rows, int columns, long[] elements, int rowZero, int columnZero,
    ...
    protected LongMatrix2D viewSelectionLike(int[] rowOffsets, int[] columnOffsets) {
        return new SelectedDenseLongMatrix2D(this.elements, rowOffsets, columnOffsets, this.offset);
    }
}
