...
public abstract class LongMatrix3D extends AbstractMatrix3D {
    ...
    @Serial
    private static final long serialVersionUID = -9064306559860314125L;
    ...
    public boolean equals(Object obj) {
        ...
        return cern.mateba.matrix.tlong.algo.LongProperty.DEFAULT.equals(this, (LongMatrix3D) obj);
    }
     ...
     * information, see
     * {@link cern.mateba.matrix.tlong.algo.LongSorting#sort(LongMatrix3D,int,int)}
    ...
    public LongMatrix3D viewSorted(int row, int column) {
        return cern.mateba.matrix.tlong.algo.LongSorting.mergeSort.sort(this, row, column);
    }
