...
import cern.mateba.map.tdouble.AbstractLongDoubleMap;
import cern.mateba.map.tdouble.OpenLongDoubleHashMap;
 ...
 * {@link cern.mateba.map.tdouble.OpenLongDoubleHashMap}, which is a compact and
...
public class SparseDoubleMatrix2D extends DoubleMatrix2D {
    ...
    public DoubleMatrix2D assign(cern.mateba.function.tdouble.DoubleFunction function) {
    ...
    public DoubleMatrix2D assign(final DoubleMatrix2D y, cern.mateba.function.tdouble.DoubleDoubleFunction function) {
        ...
        if (function instanceof cern.jet.math.tdouble.DoublePlusMultSecond) { // x[i] = x[i] + alpha*y[i]
            ...
            this.elements.forEachPair(new cern.mateba.function.tdouble.LongDoubleProcedure() {
