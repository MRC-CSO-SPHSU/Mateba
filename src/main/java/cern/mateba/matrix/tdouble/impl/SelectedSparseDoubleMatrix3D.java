...
class SelectedSparseDoubleMatrix3D extends DoubleMatrix3D {
    ...
    @Serial
    private static final long serialVersionUID = -2760645206321210026L;
    /**
     ...
     */
    protected SelectedSparseDoubleMatrix3D(AbstractLongDoubleMap elements, int[] sliceOffsets, int[] rowOffsets,
