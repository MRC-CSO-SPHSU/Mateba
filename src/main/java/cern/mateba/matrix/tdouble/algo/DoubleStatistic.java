...
public class DoubleStatistic {
    ...
    public static DoubleMatrix2D covariance(DoubleMatrix2D matrix) {
        ...
        DoubleMatrix2D covariance = new cern.mateba.matrix.tdouble.impl.DenseDoubleMatrix2D(columns, columns);
    ...
    public static IHistogram2D cube(DoubleMatrix1D x, DoubleMatrix1D y, DoubleMatrix1D weights) {
        ...
        cern.mateba.list.tdouble.DoubleArrayList distinct = new cern.mateba.list.tdouble.DoubleArrayList();
        double[] vals = new double[(int) x.size()];
        cern.mateba.list.tdouble.DoubleArrayList sorted = new cern.mateba.list.tdouble.DoubleArrayList(vals);
    ...
    public static void demo1() {
        ...
        // System.out.println(cern.mateba.matrixpattern.Converting.toHTML(A.toString()));
        // System.out.println(cern.mateba.matrixpattern.Converting.toHTML(covariance(A).toString()));
        // System.out.println(cern.mateba.matrixpattern.Converting.toHTML(correlation(covariance(A)).toString()));
        // System.out.println(cern.mateba.matrixpattern.Converting.toHTML(distance(A,EUCLID).toString()));
    }
    ...
    public static DoubleMatrix2D distance(DoubleMatrix2D matrix, VectorVectorFunction distanceFunction) {
        int columns = matrix.columns();
        DoubleMatrix2D distance = new cern.mateba.matrix.tdouble.impl.DenseDoubleMatrix2D(columns, columns);
