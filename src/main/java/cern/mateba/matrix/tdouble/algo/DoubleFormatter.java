...
public class DoubleFormatter extends AbstractFormatter {
    ...
    public static void demo3(int size, double value) {
        cern.mateba.Timer timer = new cern.mateba.Timer();
        String s;
        StringBuffer buf;
        DoubleMatrix2D matrix = cern.mateba.matrix.tdouble.DoubleFactory2D.dense.make(size, size, value);
    ...
    public static void demo6() {
        ...
        // System.out.println(cern.mateba.matrix.DoubleFactory2D.dense.make(values));
    ...
    public String toTitleString(DoubleMatrix2D matrix, String[] rowNames, String[] columnNames, String rowAxisName,
        ...
        if (columnNames != null) {
            cern.mateba.list.tobject.ObjectArrayList list = new cern.mateba.list.tobject.ObjectArrayList(columnNames);
            list.add("|");
        ...
        if (rowNames != null) {
            cern.mateba.list.tobject.ObjectArrayList list = new cern.mateba.list.tobject.ObjectArrayList(rowNames);
            for (int i = 0; i < aggr.length; i++)
                list.add(aggr[i].name()); // add names of aggregation
            // functions
