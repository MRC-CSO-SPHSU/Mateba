...
public class DoubleNotConvergedException extends Exception {
     ...
     *
     * @param reason  The reason for the lack of convergence
     * @param message A more descriptive explanation
     */
    public DoubleNotConvergedException(Reason reason, String message) {
        super(message);
        this.reason = reason;
    }
