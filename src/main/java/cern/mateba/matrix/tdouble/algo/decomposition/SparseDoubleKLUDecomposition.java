...
public class SparseDoubleKLUDecomposition implements SparseDoubleLUDecomposition {
    private final KLU_symbolic S;
    private final KLU_numeric N;
    private final KLU_common Common;
     ...
     * @param order           ordering option (0 to 1); 0: AMD, 1: COLAMD
     ...
     * @throws IllegalArgumentException if <tt>order</tt> is not in [0,1]
     */
