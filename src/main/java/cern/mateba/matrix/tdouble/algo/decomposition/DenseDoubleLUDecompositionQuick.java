...
import cern.mateba.matrix.tdouble.algo.DoubleProperty;
 ...
 * <p>
 */
public class DenseDoubleLUDecompositionQuick implements java.io.Serializable {
    ...
    protected DenseDoubleAlgebra algebra;
     ...
     */
    public DenseDoubleLUDecompositionQuick() {
     ...
     */
    public DenseDoubleLUDecompositionQuick(double tolerance) {
        this.algebra = new DenseDoubleAlgebra(tolerance);
    }
    ...
    public void decompose(DoubleMatrix2D A) {
        ...
        cern.mateba.list.tint.IntArrayList nonZeroIndexes = new cern.mateba.list.tint.IntArrayList(); // sparsity
        DoubleMatrix1D LUcolj = LU.viewColumn(0).like(); // blocked column j
        cern.jet.math.tdouble.DoubleMult multFunction = cern.jet.math.tdouble.DoubleMult.mult(0);
    ...
    public void solve(DoubleMatrix2D B) {
        ...
        // transformations
        cern.jet.math.tdouble.DoubleMult div = cern.jet.math.tdouble.DoubleMult.div(0);
        cern.jet.math.tdouble.DoublePlusMultSecond minusMult = cern.jet.math.tdouble.DoublePlusMultSecond.minusMult(0);

        cern.mateba.list.tint.IntArrayList nonZeroIndexes = new cern.mateba.list.tint.IntArrayList(); // sparsity
        DoubleMatrix1D Browk = cern.mateba.matrix.tdouble.DoubleFactory1D.dense.make(nx); // blocked
        // row
        // k
        ...
        for (int k = n - 1; k >= 0; k--) {
            ...
            // blocking
            if (Browk == null)
                Browk = cern.mateba.matrix.tdouble.DoubleFactory1D.dense.make(B.columns());
            Browk.assign(Brows[k]);
