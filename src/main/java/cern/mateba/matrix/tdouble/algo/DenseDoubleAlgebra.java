...
import cern.mateba.matrix.Norm;
...
import cern.mateba.matrix.tdouble.algo.decomposition.DenseDoubleCholeskyDecomposition;
import cern.mateba.matrix.tdouble.algo.decomposition.DenseDoubleEigenvalueDecomposition;
import cern.mateba.matrix.tdouble.algo.decomposition.DenseDoubleLUDecomposition;
import cern.mateba.matrix.tdouble.algo.decomposition.DenseDoubleQRDecomposition;
import cern.mateba.matrix.tdouble.algo.decomposition.DenseDoubleSingularValueDecomposition;
...
public class DenseDoubleAlgebra implements Serializable, Cloneable {
    ...
    public DoubleMatrix2D permuteRows(final DoubleMatrix2D A, int[] indexes, int[] work) {
        ...
        cern.mateba.GenericPermuting.permute(indexes, swapper, work, null);
        return A;
    }
    ...
    public DoubleMatrix2D pow(DoubleMatrix2D A, int p) {
        ...
        int k = cern.mateba.matrix.tbit.QuickBitVector.mostSignificantBit(p);
    ...
    public String toString(DoubleMatrix2D matrix) {
        final cern.mateba.list.tobject.ObjectArrayList names = new cern.mateba.list.tobject.ObjectArrayList();
        final cern.mateba.list.tobject.ObjectArrayList values = new cern.mateba.list.tobject.ObjectArrayList();
        ...
        cern.mateba.GenericSorting.quickSort(0, names.size(), comp, swapper);
