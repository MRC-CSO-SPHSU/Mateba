...
import cern.mateba.matrix.tobject.impl.DenseObjectMatrix1D;
import cern.mateba.matrix.tobject.impl.SparseObjectMatrix1D;
...
public class ObjectFactory1D implements Serializable, Cloneable {
    ...
    @Override
    public ObjectFactory1D clone() {
        try {
            return (ObjectFactory1D) super.clone();
