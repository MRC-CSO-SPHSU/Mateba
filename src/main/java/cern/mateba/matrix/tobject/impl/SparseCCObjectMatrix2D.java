...
public class SparseCCObjectMatrix2D extends WrapperObjectMatrix2D {
    @Serial
    private static final long serialVersionUID = 3354920893052854611L;
    /*
     * Internal storage.
     */
    ...
    public ObjectMatrix2D assign(final cern.mateba.function.tobject.ObjectFunction function) {
        forEachNonZero(new cern.mateba.function.tobject.IntIntObjectFunction() {
    ...
    public ObjectMatrix2D assign(ObjectMatrix2D source) {
        ...
        if (source instanceof SparseCCObjectMatrix2D other) {
            ...
            assign((Object) null);
            source.forEachNonZero(new cern.mateba.function.tobject.IntIntObjectFunction() {
                public Object apply(int i, int j, Object value) {
                    setQuick(i, j, value);
                    return value;
                }
