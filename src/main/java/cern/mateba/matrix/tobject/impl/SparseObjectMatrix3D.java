...
import cern.mateba.map.tobject.OpenLongObjectHashMap;
 ...
 * {@link cern.mateba.map.tobject.OpenLongObjectHashMap}, which is a compact and
...
public class SparseObjectMatrix3D extends ObjectMatrix3D {
     ...
     * </ul>
     * A sequence like <tt>set(s,r,c,5); set(s,r,c,0);</tt> sets a cell to
