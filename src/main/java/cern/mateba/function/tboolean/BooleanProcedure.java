 ...
 */
package cern.mateba.function.tboolean;
...
public interface BooleanProcedure {
     ...
     * continue normally or terminate (because for example a matching element has been found), a procedure can
     * return {@code false} to indicate termination and {@code true} to indicate continuation.
     *
