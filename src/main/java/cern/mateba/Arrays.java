...
public class Arrays {
     ...
     */
    public static byte @NotNull [] ensureCapacity(byte @NotNull [] array, int minCapacity) {
        if (minCapacity < 1)
            throw new IllegalArgumentException("Incorrect array capacity.");
        ...
        if (minCapacity > oldCapacity) {
            ...
            val newArray = new byte[newCapacity];
