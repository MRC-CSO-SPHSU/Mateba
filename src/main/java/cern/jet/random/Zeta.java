...
public class Zeta extends AbstractDiscreteDistribution {
    ...
    @Serial
    private static final long serialVersionUID = 4834213581048460638L;
    protected double ro;
    ...
    protected long generateZeta(double ro, double pk, RandomEngine randomGenerator) {
         ...
         * ***************************************************************** *
         * FUNCTION: - zeta samples a random number from the * Zeta distribution
         * with parameters ro > 0 and * pk >= 0. * REFERENCE: - J. Dagpunar
         * (1988): Principles of Random * Variate Generation, Clarendon Press,
         * Oxford. * *
         **********************************************************************/
        double u, v, e, x;
        long k;
