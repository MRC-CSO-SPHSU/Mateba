...
public class Empirical extends AbstractContinousDistribution {
    ...
    @Serial
    private static final long serialVersionUID = 4943941276223080524L;
    ...
    public double nextDouble() {
        ...
        // after this binary search, nabove is always nbelow+1 and they straddle
        // rand:
        ...
        if (this.interpolationType == NO_INTERPOLATION) {
            ...
            if (binMeasure == 0.0) {
                // rand lies right in a bin of measure 0. Simply return the
                // center
                // of the range of that bin. (Any value between k/N and (k+1)/N
                // is
            ...
            throw new InternalError(); // illegal interpolation type
    }
