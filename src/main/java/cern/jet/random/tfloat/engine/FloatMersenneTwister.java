 ...
 */
public class FloatMersenneTwister extends FloatRandomEngine {
    /**
     * 
     */
    ...
    protected void setSeed(int seed) {
        ...
        /*
         * old version was: for (int i = 0; i < N; i++) { mt[i] = seed &
         * 0xffff0000; seed = 69069 * seed + 1; mt[i] |= (seed & 0xffff0000) >>>
         * 16; seed = 69069 * seed + 1; } //System.out.println("init done"); mti =
         * N;
         */
    }
}
