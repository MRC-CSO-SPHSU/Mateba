...
public abstract class DoubleRandomEngine extends Random implements RandomGenerator, DoubleFunction, IntFunction,
    LongFunction, Serializable { // fixme now that we have a different default range, check other distributions as they depend on the uniform one.
    @Serial
     ...
     */
    @Contract(" -> new")
    public static @NotNull DoubleRandomEngine makeDefault() {
