...
class KnownDoubleQuantileEstimator extends DoubleQuantileEstimator {
     ...
     */
    public KnownDoubleQuantileEstimator(int b, int k, long N, double samplingRate, DoubleRandomEngine generator) {
    ...
    protected void addInfinities(int missingInfinities, DoubleBuffer buffer) {
        DoubleRandomSamplingAssistant oldAssistant = this.samplingAssistant;
        ...
        // DoubleArrayList(infinities),0,missingInfinities-1);
    ...
    public Object clone() {
        ...
        if (this.samplingAssistant != null)
            copy.samplingAssistant = (DoubleRandomSamplingAssistant) copy.samplingAssistant.clone();
        return copy;
    }
