 ...
 */
class KnownQuantileEstimator extends QuantileEstimator {

    @Serial
    private static final long serialVersionUID = 58747006139065833L;
    ...
    public DoubleArrayList quantileElements(DoubleArrayList phis) {
         ...
         */
        Buffer partial = this.bufferSet._getPartialBuffer();
        int missingValues = 0;
