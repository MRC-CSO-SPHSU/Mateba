...
abstract class QuantileEstimator implements QuantileFinder {

    @Serial
    private static final long serialVersionUID = -2009314323496420516L;
    protected BufferSet bufferSet;

    protected Buffer currentBufferToFill;
    ...
    public void addAllOfFromTo(DoubleArrayList values, int from, int to) {
        /*
         * // the obvious version, but we can do quicker... double[] theValues =
     ...
     * Not yet commented.
     */
    protected Buffer[] buffersToCollapse() {
    ...
    public Object clone() {
        QuantileEstimator copy;
        try {
            copy = (QuantileEstimator) super.clone();
    ...
    protected void collapse() {
        Buffer[] toCollapse = buffersToCollapse();
        Buffer outputBuffer = bufferSet.collapse(toCollapse);
     ...
     * Not yet commented.
     */
    protected abstract void postCollapse(Buffer[] toCollapse);
    ...
    public DoubleArrayList quantileElements(DoubleArrayList phis) {
        /*
         * //check parameter DoubleArrayList sortedPhiList = phis.copy();
        ...
        Buffer[] fullBuffers = bufferSet._getFullOrPartialBuffers();
    ...
    protected void setUp(int b, int k) {
        ...
        this.bufferSet = new BufferSet(b, k);
        this.clear();
    }
