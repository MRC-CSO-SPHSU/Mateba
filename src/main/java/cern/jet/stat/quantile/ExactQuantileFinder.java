...
public class ExactQuantileFinder implements QuantileFinder, Cloneable {


    @Serial
    private static final long serialVersionUID = -7888050700998565470L;
    ...
    public Object clone() {
        ExactQuantileFinder copy;
        try {
            copy = (ExactQuantileFinder) super.clone();
