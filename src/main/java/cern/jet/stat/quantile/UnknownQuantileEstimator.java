 ...
 */
class UnknownQuantileEstimator extends QuantileEstimator {

    @Serial
    private static final long serialVersionUID = 4174283455294665623L;
    ...
    public Object clone() {
        var copy = (UnknownQuantileEstimator) super.clone();
    ...
    protected void postCollapse(Buffer[] toCollapse) {
     ...
     */
    protected static void sortAscendingByLevel(Buffer[] fullBuffers) {
