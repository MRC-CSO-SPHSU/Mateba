...
import cern.jet.stat.AllocatableBuffer;
 ...
 */
public class Buffer extends AllocatableBuffer {

    @Serial
    private static final long serialVersionUID = -8997379852810172472L;
    ...
    public Buffer clone() {
        Buffer copy = (Buffer) super.clone();
        if (this.values != null)
