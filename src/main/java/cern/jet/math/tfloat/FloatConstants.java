...
public class FloatConstants {
     ...
     * machine constants
     */
    protected static final float MACHEP = 1.1102230E-16f;

    protected static final float MAXLOG = 7.0978271E2f;

    protected static final float MINLOG = -7.4513322E2f;

    protected static final float MAXGAM = 171.6243770f;

    protected static final float SQTPI = 2.5066283E0f;

    protected static final float SQRTH = 7.0710678E-1f;

    protected static final float LOGPI = 1.14472999f;

    protected static final float big = 4.5035996e15f;

    protected static final float biginv = 2.2204460e-16f;
