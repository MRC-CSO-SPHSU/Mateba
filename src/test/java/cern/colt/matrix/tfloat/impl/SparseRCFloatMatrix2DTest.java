...
public class SparseRCFloatMatrix2DTest extends FloatMatrix2DTest {
    ...
    //        float alpha = 2;
    //        float beta = 5;
    //        FloatMatrix2D C = new SparseRCFloatMatrix2D(A.rows(), A.rows(), A.rows() * A.rows());
    ...
    //
    //        //transposeA
    //        C = new SparseRCFloatMatrix2D(A.columns(), A.columns(), A.columns() * A.columns());
    //        expected = C.toArray();
    ...
    //
    //        //transposeB
    //        C = new SparseRCFloatMatrix2D(A.rows(), A.rows(), A.rows() * A.rows());
    //        expected = C.toArray();
