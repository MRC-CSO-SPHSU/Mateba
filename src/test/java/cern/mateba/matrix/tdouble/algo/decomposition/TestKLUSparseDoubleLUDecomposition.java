...
public class TestKLUSparseDoubleLUDecomposition {
    ...
    private static void testLU(DoubleMatrix2D A1, DoubleMatrix2D A2, DoubleMatrix1D B1, DoubleMatrix1D B2) {
        ...
        SparseDoubleLUDecomposition lu = new SparseDoubleKLUDecomposition(A2, 0, true);
        ...
        System.out.print("\n");
        System.out.print("------ KLUSparseDoubleLUFactorization tests-------  \n");
        ...
        if ((info_solution == 0)) {
            System.out.print("***************************************************\n");
            System.out.print(" ---- KLUSparseDoubleLUFactorization tests... PASSED !\n");
            System.out.print("***************************************************\n");
        } else {
            System.out.print("***************************************************\n");
            System.out.print(" ---- KLUSparseDoubleLUFactorization tests... FAILED !\n");
            System.out.print("***************************************************\n");
        }
    }
