...
import cern.mateba.matrix.tlong.LongMatrix2DTest;

public class SparseCCLongMatrix2DTest extends LongMatrix2DTest {

    public SparseCCLongMatrix2DTest(String arg0) {
        super(arg0);
    }
    ...
    //        long alpha = 2;
    //        long beta = 5;
    //        LongMatrix2D C = new SparseCCLongMatrix2D(NROWS, NROWS, NROWS * NROWS);
    ...
    //
    //        //transposeA
    //        C = new SparseCCLongMatrix2D(A.columns(), A.columns(), A.columns() * A.columns());
    //        expected = C.toArray();
    ...
    //
    //        //transposeB
    //        C = new SparseCCLongMatrix2D(A.rows(), A.rows(), A.rows() * A.rows());
    //        expected = C.toArray();
