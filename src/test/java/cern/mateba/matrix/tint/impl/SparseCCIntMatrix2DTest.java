...
import cern.mateba.matrix.tint.IntMatrix2DTest;

public class SparseCCIntMatrix2DTest extends IntMatrix2DTest {

    public SparseCCIntMatrix2DTest(String arg0) {
        super(arg0);
    }
    ...
    //        int alpha = 2;
    //        int beta = 5;
    //        IntMatrix2D C = new SparseCCIntMatrix2D(NROWS, NROWS, NROWS * NROWS);
    ...
    //
    //        //transposeA
    //        C = new SparseCCIntMatrix2D(A.columns(), A.columns(), A.columns() * A.columns());
    //        expected = C.toArray();
    ...
    //
    //        //transposeB
    //        C = new SparseCCIntMatrix2D(A.rows(), A.rows(), A.rows() * A.rows());
    //        expected = C.toArray();
