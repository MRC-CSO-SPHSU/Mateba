 ...
 * '99). Methods taking as argument a uniform random generator are <b>not
 * synchronized</b> and therefore much <b>quicker</b>. Thus, if you need a lot
 * of random numbers, you should use the unsynchronized approach:
 * <p>
 * <b>Example usage:</b>
 * 
 * <pre>
...
public class Benchmark {
    ...
    public static void benchmark(int times) {
        ...
        /*
         * gen = new edu.stanford.mt.MersenneTwister(); System.out.println("\n
         * edu.stanford.mt.MersenneTwister:"); timer.reset().start(); for (int
         * i=times; --i>=0; ) gen.raw(); timer.stop().display();
         * System.out.println(times/(timer.elapsedTime()-emptyLoop)+ " numbers
         * per second.");
         */
    ...
    /**
     * Prints the first <tt>size</tt> random numbers generated by the given
     * engine.
     */
    public static void test(int size, DoubleRandomEngine randomEngine) {
        DoubleRandomEngine random;

        /*
         * System.out.println("raw():"); random = (RandomEngine)
         * randomEngine.clone(); //cern.colt.Timer timer = new
         * cern.colt.Timer().start(); for (int j=0, i=size; --i>=0; j++) {
         * System.out.print(" "+random.raw()); if (j%8==7) System.out.println(); }
         * 
         * System.out.println("\n\nfloat():"); random = (RandomEngine)
         * randomEngine.clone(); for (int j=0, i=size; --i>=0; j++) {
         * System.out.print(" "+random.nextFloat()); if (j%8==7)
         * System.out.println(); }
         * 
         * System.out.println("\n\ndouble():"); random = (RandomEngine)
         * randomEngine.clone(); for (int j=0, i=size; --i>=0; j++) {
         * System.out.print(" "+random.nextDouble()); if (j%8==7)
         * System.out.println(); }
         */
        System.out.println("\n\nint():");
        random = (DoubleRandomEngine) randomEngine.clone();
    ...
    private static void xtestRandomFromTo(long from, long to, int times) {
        ...
        // cern.colt.set.OpenMultiFloatHashSet multiset = new
        // cern.colt.set.OpenMultiFloatHashSet();
