...
public class BenchmarkSparseCCDoubleMatrix2D {
    ...
    public static void main(String[] args) {
        if (args.length < 2) {
            System.out
                    .println("Usage: java cern.colt.matrix.tdouble.impl.BenchmarkSparseCCDoubleMatrix2D fileName nthreads1 [nthreads2 ... nthreadsn]");
            System.exit(-1);
        }
    ...
    public static void benchmarkZMult(String fileName) {
        ...
        System.out.println("Benchmark of SparseCCDoubleMatrix2D (" + file.getName() + ")");
        int rows = A.rows();
